...
*Note: The figures below reflect market data as of May 2024 and are included for illustrative purposes. Actual prices and correlations will differ at the time of reading.*

Over the two years prior to May 2024, the price of gold increased by approximately **25.94%**. In the three months leading up to May 2024 alone, gold prices surged by around **13.83%**. In comparison, [the cumulative **inflation rate** in the US between December 2021 and December 2023 stood at around **9.2%** (**6.5%** + **2.7%** estimated)](https://www.thebalancemoney.com/u-s-inflation-rate-history-by-year-and-forecast-3306093){:target="_blank"}. This provides a good indication of how closely the gold price can align with **inflation** over time.
...
As of May 2024, comparing the performance between gold and **Bitcoin (BTC)**: Bitcoin had surged by **132.44%** over the prior year, whereas gold had seen an increase of **14.66%**. However, it's important to note the higher volatility associated with Bitcoin, which means that one may have bought or sold BTC at the wrong time. Similar results are observed with **Ethereum (ETH)**, albeit with a lower **return on investment (ROI)** and even higher **volatility**.
